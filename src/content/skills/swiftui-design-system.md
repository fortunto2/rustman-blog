...
description: "Build and hold a SwiftUI design system — a 12-column grid, spacing/type/radius/motion scales, surface levels, a component gallery, and the guards that stop it drifting back. Use when the user says or when a screen's spacing and fonts were each chosen once and never against each other"
created: 2026-04-09
tags: [skill, utility, solo-factory]
phase: "utility"
phase_order: 99
publish: true
source_url: "https://github.com/fortunto2/solo-factory/tree/main/skills/swiftui-design-system"
---
