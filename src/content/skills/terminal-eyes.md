---
title: "/terminal-eyes"
description: "Set up a terminal for hours of reading agent output without eye strain — kill flicker and blinking, pick a polarity that fits the room, fix the ANSI palette so accents stay readable, and swap watching-the-stream for a bell. Use when the user says or after switching to a light background"
created: 2026-04-09
tags: [skill, utility, solo-factory]
phase: "utility"
phase_order: 99
publish: true
source_url: "https://github.com/fortunto2/solo-factory/tree/main/skills/terminal-eyes"
---
