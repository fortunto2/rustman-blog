...
fast_tooling: "Same opt-in native gates as nextjs-supabase: oxlint (Rust pre-commit gate), tsgo --noEmit (when out of RC), reactCompiler: true (React 19), OpenAPI codegen for tool/API types. 10-100x. See nextjs-supabase.yaml + wiki native-frontend-toolchain"
