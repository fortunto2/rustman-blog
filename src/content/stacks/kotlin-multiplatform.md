...
gradle_required:
  android_config:
    ...
    # Play blocks uploads that target more than ~1 year behind the latest Android release.
    # API 35 → dead 31 Aug 2025 · API 36 (Android 16) → dead 31 Aug 2026. Start at the newest.
    compileSdk: 36
    targetSdk: 36
    minSdk: 26
    versionCode: 1
