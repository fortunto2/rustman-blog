...
tags: [stream, decision-framework, principles, life-design]
publish: true
key_claims:
  - "6 principle layers (STREAM) form a hierarchy: each layer builds on the previous"
  - "5-step decision framework walks through epistemics → systems → time → risk → execution"
